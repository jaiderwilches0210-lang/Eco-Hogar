        ...
        <div class="historial-filters">
            <form method="GET" action="">
                <div class="filter-group">
                    ...
                    <input type="text" id="admin_name" name="admin_name" placeholder="Nombre Admin" value="<?php echo $_GET['admin_name'] ?? ''; ?>">
                </div>
                ...
                <div class="filter-group">
                    ...
                    <select id="tipo_mov" name="tipo_mov">
                        ...
                        <option value="1" <?php if (isset($_GET['tipo_mov']) && $_GET['tipo_mov'] == '1') echo 'selected'; ?>>Ingreso</option>
                        <option value="2" <?php if (isset($_GET['tipo_mov']) && $_GET['tipo_mov'] == '2') echo 'selected'; ?>>Egreso</option>
                        <option value="3" <?php if (isset($_GET['tipo_mov']) && $_GET['tipo_mov'] == '3') echo 'selected'; ?>>Actualización</option>
                        <option value="4" <?php if (isset($_GET['tipo_mov']) && $_GET['tipo_mov'] == '4') echo 'selected'; ?>>Eliminación</option>
                    </select>
                </div>
            
                <div class="filter-group">
                    <label for="filter_date">Filtrar por Fecha:</label>
                    <input type="date" id="filter_date" name="filter_date" value="<?php echo $_GET['filter_date'] ?? ''; ?>">
                </div>
